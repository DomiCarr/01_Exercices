import Formulaire from "./js27f.js";

// Créer le formulaire
export const formulaire = new Formulaire('formulaire');

// masquer les champs qui doivent masqués de base
...
// addEventListener pour changer le comportement en fonction de objet (offre emploi)
...
formulaire.formulaireHtml.addEventListener('submit',
    (event) => {
        ...
        console.log("formulaire.answers: ", formulaire.answers);
    }
)
